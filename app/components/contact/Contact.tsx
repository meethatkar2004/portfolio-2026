...
export default function Contact() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl mx-auto px-6 mt-12 text-left">
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              ...
              <div className="relative border-b border-white/20 pb-2 group transition-colors duration-300 hover:border-yellow-400/50">
                <label
                  ...
                  className={`absolute left-0 bottom-3 text-lg transition-all duration-300 pointer-events-none ${
                    focusedField === 'name' || formState.name
                      ? '-translate-y-8 text-sm text-yellow-400 font-bold uppercase tracking-wider'
                ...
                />
                <span
                  className={`absolute bottom-0 left-0 h-[2px] bg-yellow-400 transition-all duration-500 ease-out ${
            ...
            <div className="flex justify-end pt-6">
              ...
              >
                <span className="absolute inset-0 bg-yellow-400 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out z-0" />
