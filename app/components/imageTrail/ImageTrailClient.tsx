...
type ImageTrailClientProps = {
  skillImages: SkillImage[];
  enabled?: boolean;
  threshold?: number;
};

export default function ImageTrailClient({ skillImages, enabled = true, threshold = 100 }: ImageTrailClientProps) {
